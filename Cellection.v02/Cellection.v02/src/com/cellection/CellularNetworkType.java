...
public enum CellularNetworkType {
	...
	public static String getLabel(int value) {
		CellularNetworkType[] cellularNetworkTypeArr = CellularNetworkType.values();
		for (int i = 0; i < cellularNetworkTypeArr.length; i++) {
			CellularNetworkType cellularNetworkType = cellularNetworkTypeArr[i];
