...
public class CellUtil {
	...
	public static Long checkAndInsertPoorSignal(double latitude,double longitude, int strength, String name, Context signalStrengthService) {
		PoorNetworkDBHelper poorNetworkDBHelper = new PoorNetworkDBHelper(signalStrengthService);
		Cursor cursor = poorNetworkDBHelper.getRecord(name);
		...
		if (addReport) {
			id = insertPoorSignal(latitude, longitude, strength, name, poorNetworkDBHelper);
		}
		return id;
	}

	private static Long insertPoorSignal(double latitude, double longitude, int strength, String name, PoorNetworkDBHelper poorNetworkDBHelper) {
